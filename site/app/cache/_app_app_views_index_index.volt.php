    ...
    <v-layout
        ...
        <v-flex xs11 sm10 lg8>
            <v-text-field
                    ...
                    solo
            >
                <v-btn slot="prepend" flat icon color="accent" style="margin-top: -6px;">
                    <v-icon>settings</v-icon>
                </v-btn>

                <v-tooltip slot="prepend-inner" bottom>
                    <v-btn slot="activator" flat icon>
                        <v-icon v-if="location" color="accent">location_on</v-icon>
                ...
                <div slot="append-outer" style="display: flex; flex-direction: row; margin-top: -12px;">
                    <v-btn flat icon color="accent" @click="efetuarBusca">
